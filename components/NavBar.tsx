  ...
  return (
    ...
    >
      ...
      <NavbarContent className="hidden sm:flex gap-4" justify="center">
        ...
        <NavbarItem>
          <Link color={pathname === "/clientes" ? undefined : "foreground"} href="/clientes">
            Clientes
          </Link>
        </NavbarItem>
        <NavbarItem>
          <Link color={pathname === "/rutas" ? undefined : "foreground"} href="/rutas" >
            Rutas
          </Link>
        </NavbarItem>
        <NavbarItem>
          <Link color={pathname === "/pedidos" ? undefined : "foreground"} href="/pedidos" >
            Pedidos
          </Link>
        </NavbarItem>
        <NavbarItem>
          <Link color={pathname === "/productos" ? undefined : "foreground"} href="/productos">
            Productos
          </Link>
        </NavbarItem>
      </NavbarContent>
